...
<div>
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <select wire:model="role" id="role" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" name="role" required
                autocomplete="role">
